...
NEXT_STOP_TABLE = f"{catalog_name}.{SILVER_NAMESPACE}.next_stop"
CALENDAR_TABLE = f"{catalog_name}.{SILVER_NAMESPACE}.day_type_calendar"
DELAYS_BY_STOP_TABLE = f"{catalog_name}.{GOLD_NAMESPACE}.delays_by_stop"

NEXT_STOP_FEATURES_TABLE = f"{catalog_name}.{GOLD_NAMESPACE}.next_stop_features"
